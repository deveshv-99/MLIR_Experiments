func.func @main() {
    ...
    %cast_arg0 = memref.cast %arg0 : memref<4xf32> to memref<*xf32>
    gpu.host_register %cast_arg0 : memref<*xf32>
    %cast_arg1 = memref.cast %arg1 : memref<4xf32> to memref<*xf32>
    gpu.host_register %cast_arg1 : memref<*xf32>
    %cast_arg2 = memref.cast %arg2 : memref<4xf32> to memref<*xf32>
    ...
    gpu.launch blocks(%bx, %by, %bz) in (%grid_x = %c1, %grid_y = %c1, %grid_z = %c1) 
        ...
        %val0 = memref.load %arg0[%tx] : memref<4xf32>
        %val1 = memref.load %arg1[%tx] : memref<4xf32>

        %add = arith.addf %val0, %val1 : f32

        memref.store %add, %arg2[%tx] : memref<4xf32>
